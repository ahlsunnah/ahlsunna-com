...
const SecondPage = () => (
  <Layout>
    ...
    <h2>Ahlsunnah Dev Terms of Service</h2>
    <h3>1. Terms</h3>
    <p>
      By accessing the website at{' '}
      <a href="http://ahlsunnah.dev">http://ahlsunnah.dev</a>, you are agreeing
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on Ahlsunnah Dev's website for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by Ahlsunnah Dev at any time. Upon
    ...
    <ol type="a">
      <li>
        The materials on Ahlsunnah Dev's website are provided on an 'as is'
        basis. Ahlsunnah Dev makes no warranties, expressed or implied, and
      ...
      <li>
        Further, Ahlsunnah Dev does not warrant or make any representations
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Ahlsunnah Dev or its suppliers be liable for any damages
      ...
      materials on Ahlsunnah Dev's website, even if Ahlsunnah Dev or a Ahlsunnah
      Dev authorized representative has been notified orally or in writing of
    ...
    <p>
      The materials appearing on Ahlsunnah Dev's website could include
      technical, typographical, or photographic errors. Ahlsunnah Dev does not
      warrant that any of the materials on its website are accurate, complete or
      current. Ahlsunnah Dev may make changes to the materials contained on its
      website at any time without notice. However Ahlsunnah Dev does not make
      any commitment to update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Ahlsunnah Dev has not reviewed all of the sites linked to its website and
      is not responsible for the contents of any such linked site. The inclusion
      of any link does not imply endorsement by Ahlsunnah Dev of the site. Use
      of any such linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Ahlsunnah Dev may revise these terms of service for its website at any
